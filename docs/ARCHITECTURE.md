...
- `SunriseBackground` - светлый анимированный фон (эффект восхода/переливов).
...
### Наш центр
- `CenterSection` - контент об атмосфере дома и поддержки в Иванове.
...
- Заголовок страницы и description с гео-привязкой к Иваново.
